...
let location1_lat_input_element = document.getElementById(
  "lat1"
) as HTMLInputElement;
let location1_lon_input_element = document.getElementById(
  "lon1"
) as HTMLInputElement;

let location2_lat_input_element = document.getElementById(
  "lat2"
) as HTMLInputElement;
let location2_lon_input_element = document.getElementById(
  "lon2"
) as HTMLInputElement;
